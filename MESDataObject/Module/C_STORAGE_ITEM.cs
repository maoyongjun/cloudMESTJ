...
namespace MESDataObject.Module
{
    public class T_C_STORAGE_ITEM : DataObjectTable
    {
        ...
        public List<string> GetByItemNameAndItemSon(string ItemName, string ItemSon, OleExec DB)
        {
            string strSql = $@"select * from c_storage_item where item_name=:ItemName and item_son=:ItemSon";
