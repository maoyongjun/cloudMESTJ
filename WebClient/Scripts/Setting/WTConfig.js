...
$(document).ready(function () {
    ...
    $("#Save").on("click", function () {
        ...
        if(isNaN(strTmp)==true&&strTmp!=""){
            layer.msg("請輸入正確的數值BMinValue:" + strTmp, {
                icon: 2,
                time:3000
            }, function () {
            });
        ...
        if (isNaN(strTmp) == true && strTmp != "") {
            layer.msg("請輸入正確的數值BMaxValue:" + strTmp, {
                icon: 2,
                time: 3000
            }, function () {
            });
        ...
        if (isNaN(strTmp) == true && strTmp != "") {
            layer.msg("請輸入正確的數值CMinValue:" + strTmp, {
                icon: 2,
                time: 3000
            }, function () {
            });
        ...
        if (isNaN(strTmp) == true && strTmp != "") {
            layer.msg("請輸入正確的數值CMaxValue:" + strTmp, {
                icon: 2,
                time: 3000
            }, function () {
            });
