    ...
    public class BackFlushHelp : taskBase
    {
        ...
        public override void init()
        {
            try
            {
                _BU = ConfigGet("BU");
                DBName = ConfigGet("DB");
                Plant = System.Configuration.ConfigurationSettings.AppSettings[_BU +"_SAP_Plant"];
