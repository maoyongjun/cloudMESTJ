...
namespace MESStation.Label
{
    public class TestLabel2 : LabelBase
    {
        ...
        LabelOutput O_MAC = new LabelOutput() { Name = "MAC", Type = LableOutPutTypeEnum.StringArry, Description = "", Value = new List<string>() };
        LabelOutput O_CARTION = new LabelOutput() { Name = "CARTION", Type = LableOutPutTypeEnum.String, Description = "", Value = "" };
