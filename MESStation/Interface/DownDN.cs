...
namespace MESStation.Interface
{
    class DownDN : MesAPIBase
    {
        ...
        public void DownloadDetail(string SO, string Plant)
        {
            ...
            zrfc_GET_SHIP_DETAIL.SetValues(SO, Plant);//NHGZ,WDN1//WDN1,WSL3
            zrfc_GET_SHIP_DETAIL.CallRFC();

            DataTable result = zrfc_GET_SHIP_DETAIL.GetTableValue("SHIPORDERHEADER");
        ...
        public void Download(string SO, string Plant)
        {
            ...
            zrfc_GET_SHIP_HEADER.SetValues(SO, Plant);
